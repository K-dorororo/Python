...
titanic.to_csv('C:\\titanic\\titanic.csv', index = False)
...
ax[0].set_ylabel('Survived Percent')

ax[1].set_title('Survived (Female)')
ax[1].set_ylabel('Survived Percent')
...
titanic_corr.to_csv('C:/titanic/titanic_corr.csv', index = False)
...
titanic.to_csv('C:/titanic/titanic3.csv', index = False)
